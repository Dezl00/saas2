...
export default function PushNotificationsClient({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white border-2 border-surface-100 rounded-[24px] p-6 lg:p-8 flex items-center justify-between gap-4">
        <div>
        ...
        <div className="flex items-center justify-center w-16 h-16 bg-primary-100 rounded-[24px] text-primary-600 font-black text-2xl">
          {subscribersCount}
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        ...
        <div className="bg-white border-2 border-surface-100 rounded-[24px] p-6 lg:p-8 h-max">
          ...
          <form onSubmit={handleSend} className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-5 py-3.5 bg-white border border-surface-200 rounded-[24px] text-surface-950 font-medium focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-colors outline-none resize-none"
              ></textarea>
            </div>
            <div>
              ...
              <input
                ...
                className="w-full px-5 py-3.5 bg-white border border-surface-200 rounded-[24px] text-surface-950 font-medium focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-colors outline-none text-left"
                dir="ltr"
              />
            </div>
            <div>
            ...
            <button
              ...
              className="w-full mt-4 py-4 bg-primary-600 hover:bg-primary-700 text-white rounded-[24px] font-bold transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {isSending ? (
        ...
        <div className="bg-white border-2 border-surface-100 rounded-[24px] p-6 lg:p-8">
          <div className="flex items-center justify-between mb-6">
            ...
            {campaigns.length > 0 && (
              <a href="/dashboard/marketing/push-notifications/history" className="text-sm font-bold text-primary-600 hover:text-primary-700 transition-colors">
                عرض المزيد
              </a>
            )}
          </div>
                ...
                return (
                  <div key={camp.id} className="bg-white border-2 border-surface-100 rounded-[24px] p-5 hover:border-surface-200 transition-colors">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
                      ...
                      <div className="bg-success-50 text-success-700 px-4 py-2 rounded-[24px] text-sm font-bold whitespace-nowrap text-center">
