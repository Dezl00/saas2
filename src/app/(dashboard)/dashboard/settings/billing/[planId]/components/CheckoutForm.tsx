...
import { submitPaymentRequestAction } from "../../actions/submit-payment-request-action";
    ...
    <form action={formAction} className="bg-white rounded-[24px] border border-surface-200 overflow-hidden ">
      ...
      <div className="p-6 sm:p-8 space-y-8">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {methods.map(m => (
              <label 
                key={m.id}
                className={`relative flex flex-col p-4 border rounded-[24px] cursor-pointer transition-all ${
                  selectedMethod === m.id 
        ...
        {activeMethodObj?.instructions && (
          <div className="bg-surface-50 rounded-[24px] p-4 border border-surface-200 text-sm text-surface-700">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input 
              type="text" 
              name="transactionId" 
              className="w-full px-4 py-2.5 bg-surface-50 border border-surface-200 rounded-[24px] focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500" 
          ...
          <div>
            ...
            <div 
              ...
              className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-surface-300 border-dashed rounded-[24px] hover:border-primary-500 hover:bg-primary-50/50 transition-colors cursor-pointer"
            >
      ...
      <div className="bg-surface-50 p-6 border-t border-surface-200">
        <button
          ...
          className="w-full inline-flex justify-center items-center gap-2 px-8 py-3 text-base font-bold text-white bg-primary-600 rounded-[24px] hover:bg-primary-700 transition-colors disabled:opacity-70 "
        >
