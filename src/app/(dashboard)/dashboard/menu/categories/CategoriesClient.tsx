                ...
                <Draggable key={category.id} draggableId={category.id} index={index}>
                  {(provided, snapshot) => (
                    <div
                      ...
                      className={cn(
                        "bg-white border-2 rounded-3xl p-5 transition-colors flex flex-col relative",
                        snapshot.isDragging ? "border-primary-500 shadow-xl z-50" : "border-surface-100 hover:border-surface-200"
                      )}
                    >
                      {/* Drag Handle */}
                      <div 
                        {...provided.dragHandleProps}
                        className="absolute top-4 left-4 p-1.5 text-surface-300 hover:text-surface-600 hover:bg-surface-50 rounded-xl cursor-grab active:cursor-grabbing transition-colors"
                      >
                          ...
                          {editingId === category.id ? (
                            <div className="flex items-center gap-2 w-full">
                              <input
                                ...
                                className="flex-1 min-w-0 px-3 py-1.5 bg-surface-50 border-2 border-primary-200 rounded-xl text-surface-950 font-bold focus:border-primary-500 focus:outline-none"
                              />
                      ...
                      <div className="mt-auto pt-4 border-t-2 border-surface-50 flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <span className="inline-flex items-center px-3 py-1 rounded-xl text-xs font-bold bg-surface-50 text-surface-600 border border-surface-100">
                        ...
                        <button
                          ...
                          className="p-2 text-surface-400 hover:text-error-600 hover:bg-error-50 rounded-xl transition-colors"
                        >
