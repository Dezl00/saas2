          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 font-medium bg-white border-2 border-surface-200 rounded-2xl focus:border-primary-500 outline-none transition-all text-surface-950"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                placeholder="https://..."
                dir="ltr"
                className="w-full px-4 py-3 font-medium bg-white border-2 border-surface-200 rounded-2xl focus:border-primary-500 outline-none transition-all text-left text-surface-950"
              />
            </div>
            ...
            <div className="flex flex-col gap-3 pt-2">
              <button
                type="submit"
                disabled={isLoading}
                className="w-full py-4 font-bold text-white bg-primary-600 hover:bg-primary-700 rounded-2xl transition-all flex items-center justify-center gap-2 active:scale-[0.98] disabled:opacity-70"
              >
      ...
      <div className="lg:col-span-2">
        {banners.length === 0 ? (
          <div className="py-16 flex flex-col items-center justify-center bg-white rounded-[32px] border-2 border-surface-100 border-dashed">
            <div className="w-20 h-20 bg-surface-50 border-2 border-surface-200 rounded-2xl flex items-center justify-center mb-6">
            ...
            {banners.map((banner) => (
              <div key={banner.id} className="bg-white border-2 border-surface-100 rounded-[32px] overflow-hidden hover:border-surface-200 transition-colors flex flex-col">
                <div className="relative aspect-[2.2/1] w-full bg-surface-50 p-2">
                  <div className="relative w-full h-full rounded-2xl overflow-hidden border border-surface-100/50">
                    <Image
                      src={banner.image}
                  ...
                  <div className="absolute top-4 end-4 flex gap-2">
                    <button
                      ...
                      className="w-9 h-9 bg-white/90 backdrop-blur text-surface-700 hover:text-primary-600 rounded-xl flex items-center justify-center shadow-sm hover:shadow-md transition-all"
                    >
                      <Edit2 className="w-4 h-4" />
                    </button>
                    <button
                      onClick={() => setDeleteId(banner.id)}
                      className="w-9 h-9 bg-white/90 backdrop-blur text-surface-700 hover:text-error-600 rounded-xl flex items-center justify-center shadow-sm hover:shadow-md transition-all"
                    >
