      ...
      <div className="flex items-center justify-between px-6 py-4 md:py-6">
        <div className="flex items-center gap-4">
          <button 
            ...
            className="md:hidden p-2 -mr-2 text-surface-950 rounded-[24px] hover:bg-surface-200/50 transition-colors"
          >
        ...
        <div className="flex items-center gap-4">
          {isAdminImpersonating && (
            <form action={exitImpersonation}>
              <button
                type="submit"
                className="hidden sm:flex items-center gap-2 px-4 py-2 bg-error-100 text-error-700 rounded-[24px] font-bold hover:bg-error-200 transition-colors text-sm"
          ...
          <div className="flex items-center gap-3 cursor-pointer p-1.5 md:pr-4 md:pl-2 rounded-[24px] hover:bg-surface-100 transition-colors">
            ...
            <div className="w-10 h-10 md:w-11 md:h-11 rounded-[24px] bg-primary-100 flex items-center justify-center text-primary-700 font-bold text-lg">
              {userName.charAt(0)}
            </div>
